...
public class VodaActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ppCheck = findViewById(id.checkBox);
        pmCheck = findViewById(id.checkBox5);
        poCheck = findViewById(id.checkBox6);
        ...
        calculate.setOnClickListener(new View.OnClickListener() {
            ...
            public void chargeMthodptp(){
                ...
                if (valSn <= small) {
                    ...
                    telVal = String.valueOf((nocharge));
                    elevyVal = String.valueOf(((elevyCharge * valSn)/100));
                    tchargeVal = String.valueOf(((elevyCharge * valSn)/100));

                    hint1.setHint("Telco @no charge");
